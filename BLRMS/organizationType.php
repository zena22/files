...
<?php
	...
	<div class="container-fluid">
			...
			<u><h2 style="margin-top:90px; color:#0a2558;">Organization</h2> </u>
				...
				<form method="post" id="publisherForm">
					<div class="modal-content">
						<div class="modal-header">
							...
							<h4 class="modal-ttle"><i class="fa fa-plus"></i> Edit Organization Type</h4>
						</div>
						<div class="modal-body">						
							
							<div class="form-group">							
								<label for="publisher" class="control-label">Organization</label>							
								<input type="text" name="name" id="name" autocomplete="off" class="form-control" placeholder=" name"/>
												
							</div>
							
							<div class="form-group">
								<label for="status" class="control-label">Structure</label>							
