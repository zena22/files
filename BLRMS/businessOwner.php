...
<?php
	...
	<div class="container-fluid">
			...
			<u><h2 style="margin-top:90px; color:#0a2558;">Business Owner</h2> </u>
				...
				<form method="post" id="authorForm">
					<div class="modal-content">
						<div class="modal-header">
							...
							<h4 class="modal-ttle"><i class="fa fa-plus"></i> Edit Business Owner</h4>
						</div>
						<div class="modal-body">						
							
							<div class="form-group">							
								<label for="Income" class="control-label">Tax Payer's Name</label>							
								<input type="text" name="name" id="name" autocomplete="off" class="form-control" placeholder=" name"/>
												
							</div>
							
							<div class="form-group">
								<label for="status" class="control-label">Contact</label>							
								<input class="form-control" id="status" name="status" Type ="number">
